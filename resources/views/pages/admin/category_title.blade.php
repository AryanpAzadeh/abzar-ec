...
@section('title' , 'عناوین دسته بندی محصولات')
@section('style')
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1">دسته بندی محصولات</h5>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="{{route('admin.home')}}"><i
                                                class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active"> عناوین دسته بندی ها
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">عناوین دسته بندی محصولات</h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <div class="table-responsive">
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                @foreach($cat_titles as $category)
                                                    <tr>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{route('product.category.title.delete' , $category->id)}}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button type="submit"
                                                    ...
                                                    <div class="modal fade text-left" id="edit-{{$category->id}}"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{route('product.category.title.update' , $category->id)}}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('put')
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="select2-t form-control" name="category_id" id="category_id" required>

                                                                                @foreach($categories as $cat)
                                                                                    <option
                                                                                        value="{{$cat->id}}" {{$cat->id == $category->category_id ? 'selected' : ''}}>{{$cat->name}}</option>
                                                                                @endforeach
    ...
    <div class="modal fade text-left" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('product.category.title.store')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <label>عنوان دسته بندی: </label>
                        <div class="form-group">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" name="title" class="form-control" id="iconLeft1"
                                       placeholder="برقی" value="{{old('title')}}" required>
                                <div class="form-control-position">
                                    <i class="bx bx-pencil"></i>
                                </div>
                            </fieldset>
