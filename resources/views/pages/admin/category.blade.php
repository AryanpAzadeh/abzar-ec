...
{{--                                                    <th>تخفیف</th>--}}
                                                ...
                                                @foreach($categories as $category)
                                                    <tr>
                                                        <td>{{$category->name}}</td>
                                                        <td><img src="/storage/category_images/{{$category->image}}" width="50" height="50"></td>
{{--                                                        <td>--}}
{{--                                                            <form action="#" method="get">--}}
{{--                                                                <input type="text" class="form-control" name="discount" placeholder="40%">--}}
                                                                        ...
                                                                        <div class="form-group">
                                                                            <fieldset class="form-group position-relative has-icon-left">
                                                                                <input type="text" name="name" class="form-control" id="iconLeft1"
                                                                                       placeholder="دریل"  value="{{$category->name}}" required>
                ...
                <form action="{{route('product.category.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" name="name" class="form-control" id="iconLeft1"
                                       placeholder="دریل"  value="{{old('name')}}" required>
                                <div class="form-control-position">
                                    <i class="bx bx-pencil"></i>
                                </div>
                            </fieldset>
