            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1">صفحه محصولات</h5>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="{{route('admin.home')}}"><i
                                                class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item">نظرات محصول : {{$product->title}}
                                    </li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">نظرات محصول {{$product->title}}</h4>
                                </div>
                                                        ...
                                                        <td><a href="javascript:void (0)" data-toggle="modal" data-target="#msg-{{$comment->id}}">{{\Illuminate\Support\Str::words($comment->comment,$words = 4 , $end = '...') }} </a></td>                                                        <td>
                                                            @if($comment->active == 0)
                                                                <div class="badge badge-danger d-inline-flex align-items-center mr-1 mb-1">
                                                                    <a href="{{route('product.comment.mark' , $comment->id)}}" class="text-white">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{route('product.comment.delete' , $comment->id)}}"
                                                                          method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button type="submit"
