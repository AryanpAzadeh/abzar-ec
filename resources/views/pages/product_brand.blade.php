                ...
                <div class="col-lg-6 col-md-8">
                    <div class="inner">
                        <ul class="axil-breadcrumb">
                            ...
                            <li class="axil-breadcrumb-item" aria-current="page"><a href="{{route('page.products')}}">محصولات</a></li>
                            <li class="separator"></li>
                            <li class="axil-breadcrumb-item active" aria-current="page">برند : {{$brand->name}}</li>
                        </ul>
